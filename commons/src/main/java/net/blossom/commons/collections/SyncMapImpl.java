...
/* package */ final class SyncMapImpl<K, V> extends AbstractMap<K, V> implements SyncMap<K, V> {
    ...
    SyncMapImpl(final @NotNull IntFunction<Map<K, ExpungingEntry<V>>> function, final int initialCapacity) {
    ...
    /* package */ static final class ExpungingEntryImpl<V> implements ExpungingEntry<V> {
        ...
        @Override
        public <K> @NotNull InsertionResult<V> computeIfAbsent(final @Nullable K key, final @NotNull Function<? super K, ? extends V> function) {
            V next = null;
            for(; ; ) {
                final Object previous = this.value;
                if(previous == ExpungingEntryImpl.EXPUNGED) return new InsertionResultImpl<>(InsertionResultImpl.EXPUNGED, null, null);
        ...
        @Override
        public <K> @NotNull InsertionResult<V> computeIfPresent(final @Nullable K key, final @NotNull BiFunction<? super K, ? super V, ? extends V> remappingFunction) {
            V next = null;
            for(; ; ) {
                final Object previous = this.value;
                if(previous == ExpungingEntryImpl.EXPUNGED) return new InsertionResultImpl<>(InsertionResultImpl.EXPUNGED, null, null);
        ...
        @Override
        public <K> @NotNull InsertionResult<V> compute(final @Nullable K key, final @NotNull BiFunction<? super K, ? super V, ? extends V> remappingFunction) {
            V next = null;
            for(; ; ) {
                final Object previous = this.value;
                if(previous == ExpungingEntryImpl.EXPUNGED) return new InsertionResultImpl<>(InsertionResultImpl.EXPUNGED, null, null);
        ...
        @Override
        public <K> boolean tryUnexpungeAndCompute(final @Nullable K key, final @NotNull Function<? super K, ? extends V> function) {
        ...
        @Override
        public <K> boolean tryUnexpungeAndCompute(final @Nullable K key, final @NotNull BiFunction<? super K, ? super V, ? extends V> remappingFunction) {
            if(this.value == ExpungingEntryImpl.EXPUNGED) {
    ...
    /* package */ final class MapEntry implements Map.Entry<K, V> {
        ...
        /* package */ MapEntry(final @Nullable K key, final @NotNull V value) {
            this.key = key;
            this.value = value;
        }
    ...
    /* package */ final class EntryIterator implements Iterator<Map.Entry<K, V>> {
        ...
        /* package */ EntryIterator(final @NotNull Iterator<Map.Entry<K, ExpungingEntry<V>>> backingIterator) {
