...
public interface Gui {
    ...
    static @NotNull Builder builder(@NotNull InventoryType type, @NotNull String title) {
        return builder(type, Feature.getFeature(ChatFeature.class).createMessage(title, false));
    }
