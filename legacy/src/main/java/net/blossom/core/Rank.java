...
public enum Rank {
    ...
    public Component getPrefixComponent() {
        return ChatFeature.getFeature(ChatFeature.class).createMessage(prefix, false);
    }

    public Component getNameColorComponent() {
        return ChatFeature.getFeature(ChatFeature.class).createMessage(nameColor, false);
    }
